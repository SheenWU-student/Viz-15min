...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.reason img').forEach(item => {
        item.addEventListener('click', function () {
            ...
            switch (imageId) {
                case 'climateChange':
                    title.innerText = "Climate Change and Sustainability Challenges";
                ...
                case 'urbanInequality':
                    title.innerText = "Urban Inequality and Accessibility";
                ...
                case 'environmentalDegradation':
                    title.innerText = "Environmental Degradation and Loss of Biodiversity";
                    ...
                    break;
                case 'economicShifts':
                    title.innerText = "Economic Shifts and Job Accessibility";
